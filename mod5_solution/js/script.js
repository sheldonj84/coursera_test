  ...
  function buildAndShowHomeHTML(categories) {
    ...
    $ajaxUtils.sendGetRequest(
      ...
      function (homeHtml) {
        ...
        let random_category = chooseRandomCategory(categories);
        let chosenCategoryShortName = random_category.short_name;
        ...
        //
        let homeHtmlToInsertIntoMainPage = "'" + chosenCategoryShortName + "'";
        newHtml = insertProperty(
          homeHtml,
